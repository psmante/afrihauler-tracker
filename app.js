...
const SEED = {
  ...
  tickets: [
    ...
    { id: 'AH-16', epicId: 'ah-e4', projectId: 'afrihauler', title: 'Enterprise Insurance: Partnership proposal sent', status: 'done', priority: 'high', notes: 'Proposal sent 17 April 2026 to Managing Director, Enterprise House, High Street, Accra. Covers motor insurance, GIT, fleet, personal accident, claims API.' },
    { id: 'AH-17', epicId: 'ah-e4', projectId: 'afrihauler', title: 'Enterprise Insurance: Receive API docs + technical contact', status: 'inprogress', priority: 'high', notes: 'Awaiting response. Need: Policy Verification, Issuance, Renewal, Claims Initiation API docs + commercial model (commission/discount/hybrid).' },
