...
const SEED = {
  ...
  tickets: [
    ...
    { id: 'AH-11b', epicId: 'ah-e4', projectId: 'afrihauler', title: 'Shell Ghana: Send fuel partnership proposal', status: 'todo', priority: 'medium', notes: 'Same fuel discount/loyalty integration as GOIL proposal. Transporter fuel benefits via AfriHauler platform.' },
    { id: 'AH-11c', epicId: 'ah-e4', projectId: 'afrihauler', title: 'Star Oil: Send fuel partnership proposal', status: 'todo', priority: 'medium', notes: 'Same fuel discount/loyalty integration as GOIL proposal. Transporter fuel benefits via AfriHauler platform.' },
